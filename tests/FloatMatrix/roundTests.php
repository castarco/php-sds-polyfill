...
class roundTests extends TestCase
{
    ...
    public function test_round_default()
    {
        ...
        $this->assertInstanceOf('SDS\\FloatMatrix', $t2);
    }
     ...
     * @covers \SDS\FloatMatrix::round
     */
    public function test_round_asIntMatrix()
    {
        $t1 = FloatMatrix::fromArray([
            [1.4, 2.4, 3.5],
            [4.4, 5.5, 6.6],
        ...
        $this->assertInstanceOf('SDS\\IntMatrix', $t2);
    }

    /**
     * @covers \SDS\FloatMatrix::ceil
     */
     ...
     * @covers \SDS\FloatMatrix::ceil
     */
    public function test_ceil_asIntMatrix()
    {
        $t1 = FloatMatrix::fromArray([
            [1.4, 2.4, 3.5],
            [4.4, 5.5, 6.6],
     ...
     * @covers \SDS\FloatMatrix::floor
     */
    public function test_floor_asIntMatrix()
    {
        $t1 = FloatMatrix::fromArray([
            [1.4, 2.4, 3.5],
            [4.4, 5.5, 6.6],
