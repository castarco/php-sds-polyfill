...
{
    /**
     * @covers \SDS\Matrix::slice
     * @covers \SDS\Matrix::checkSliceSpec
     * @covers \SDS\Matrix::getNormalizedSliceSpec
     * @covers \SDS\Matrix::getShapeFromSliceSpec
     * @covers \SDS\Matrix::getShape
     * @covers \SDS\Matrix::setShape
     */
    public function test()
    {
        $t = IntMatrix::zeros(3, 3);
        $t[[0, 0]] = 1;
        $t[[0, 1]] = 2;
        $t[[0, 2]] = 3;
        $t[[1, 0]] = 4;
        ...
        $this->assertEquals([2, 2], $t2->getShape());
        ...
        $this->assertEquals([2, 2], $t3->getShape());
        ...
        $this->assertEquals([2, 2], $t4->getShape());
        ...
        $this->assertEquals([2, 2], $t5->getShape());
    }

    /**
     * @covers \SDS\Matrix::offsetGet
     * @covers \SDS\Matrix::slice
     */
