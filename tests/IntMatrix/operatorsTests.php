...
{
    /**
     * @covers \SDS\IntMatrix::neg
     */
    public function test_neg()
    {
        $t1 = IntMatrix::fromArray([
            [1, 2, 3],
            [4, 5, 6],
            [7, 8, 9]
        ]);
